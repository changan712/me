...
define(['angular', 'app', 'i18n', 'filter/filter', 'directive/com', 'service/user', 'service/company', 'service/alert', 'service/utils', 'service/constant'], function (angular, md) {

    md.controller('appCtrl', ['$rootScope', '$scope', '$state', 'user', 'company', 'alertService', 'utils','$http', 'APIHOST',function ($rootScope, $scope, $state, user, company, alertService, utils, $http, APIHOST) {
        var vm = $scope.vm = {};
        ...
        vm.wxback = function () {
            $http.get(APIHOST+'statistic/wxback').success(function (res) {
                console.log(res);
            });
            location.href = 'http://mp.weixin.qq.com';
        }
