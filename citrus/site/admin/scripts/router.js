    ...
    return function ($stateProvider, $urlRouterProvider, $controllerProvider) {
        ...
        /*.state('statistic', {
         ...
         templateUrl: 'views/statistic/index.html'
            ...
            .state('position.list', {
                url: '/list?page&date&city&department_id&keyword&order_by&order&created_by_user&apply_count&status',
                title: '职位列表',
            ...
            .state('resume.resumeNew', {
                //url: '/new-list',
                url: '/new-list?page&&gender&refer&name&position_id&work_exp&degree&order_by&order&cv_source',
                title: '新收简历',
                resolve: {
            ...
            .state('talent.talentList', {
                url: '/talent-list?_page&&gender&name&func&level&refer&exp_position&work_exp&degree&ref_name&order_by&order',
                title: '人才列表',
                resolve: {
                    ctrl: getCtrl('controller/talentList')
                },
            ...
            .state('identify', {
                url: '/identify?page&type&keyword&authentication',
                title: '员工认证',
                resolve: {
                    ctrl: getCtrl('controller/identify')
                },
                templateUrl: 'views/com/identify.html',
