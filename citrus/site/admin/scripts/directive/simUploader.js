define(['app'], function (md) {
    md.directive('simUploader', ['FileUploader', '$timeout', function (FileUploader, $timeout) {
        return {
            ...
            templateUrl: 'views/com/sim-uploader.html',
            link: function (scope, element, attrs) {
                scope.acceptFileType = scope.acceptFileType || ['png', 'jpg', 'jpeg', 'gif', 'txt', 'doc', 'dot', 'html', 'htm', 'mht', 'pdf', 'msg', 'eml', 'xls', 'xlsx', 'rtf', 'zip'];
                scope.uploadMaxSize = scope.$eval(attrs.maxSize) || 20;
                scope.label = attrs.label||'上传附件';
                scope.fileNameShow = scope.$eval(attrs.fileNameShow)|| true;
