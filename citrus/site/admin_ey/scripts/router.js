    ...
    return function ($stateProvider, $urlRouterProvider, $controllerProvider) {
        $stateProvider
            ...
            .state('resume.resumeNew', {
                //url: '/new-list',
                url: '/new-list?page&size&refer&position_id&gender&name&ref_name&position_name&work_exp&degree&edu_school&exp_position&exp_company&created_at&order_by&order',
                title: '新收简历',
                resolve: {
