...
define([
    ...
    md.controller('feedProjectCommentsCtrl', ['$rootScope', '$scope', '$state', '$location', 'feedUpdate', 'feedComment', 'feed', function ($rootScope, $scope, $state, $location, feedUpdate, feedComment, feed) {
        var vm = $scope.vm = {};
