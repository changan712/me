(function (ng, _) {
    ...
    _.each(_.methods(_), function (methodName) {
        ...
        _.each([underscoreModule, utilsModule, ng.module("angular-underscore/utils/" + methodName, [])], function (module) {
    ...
    _.each(adapList, function (filterNames) {
        ...
        _.each(filterNames, function (filterName) {
            _.each([underscoreModule, filtersModule, ng.module("angular-underscore/filters/" + filterName, [])], function (module) {
