...
define([
    ...
    //追踪
    md.controller('statisticTrackCtrl', ['$rootScope', '$scope', '$location', '$state', 'statistic', 'dialog', function ($rootScope, $scope, $location, $state, statistic, dialog) {
    ...
    //浏览量
    md.controller('statisticViewCtrl', ['$rootScope', '$scope', '$location', '$state', 'statistic', 'dialog', function ($rootScope, $scope, $location, $state, statistic, dialog) {
        $scope.sub_title = $state.current.title;
    ...
    //申请量
    md.controller('statisticApplyCtrl', ['$rootScope', '$scope', '$location', '$state', 'statistic', 'dialog', function ($rootScope, $scope, $location, $state, statistic, dialog) {
        $scope.sub_title = $state.current.title;
    ...
    //转发量
    md.controller('statisticShareCtrl', ['$rootScope', '$scope', '$location', '$state', 'statistic', 'dialog', function ($rootScope, $scope, $location, $state, statistic, dialog) {
        $scope.sub_title = $state.current.title;
    ...
    //转发效果
    md.controller('statisticShareEffectCtrl', ['$rootScope', '$scope', '$location', '$state', 'statistic', 'dialog', function ($rootScope, $scope, $location, $state, statistic, dialog) {
        $scope.sub_title = $state.current.title;
    ...
    //申请渠道
    md.controller('statisticApplyChannelCtrl', ['$rootScope', '$scope', '$location', '$state', 'statistic', 'dialog', function ($rootScope, $scope, $location, $state, statistic, dialog) {
        $scope.sub_title = $state.current.title;
    ...
    //职位推荐量
    md.controller('statisticRefCtrl', ['$rootScope', '$scope', '$location', '$state', 'statistic', 'dialog', function ($rootScope, $scope, $location, $state, statistic, dialog) {
        $scope.sub_title = $state.current.title;
