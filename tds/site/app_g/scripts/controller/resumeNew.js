...
define([
    ...
    md.controller('resumeNewCtrl', ['$rootScope', '$scope', '$ionicScrollDelegate', '$location', '$state', 'resume', 'edu', 'wxUser', 'tip', 'corp', function ($rootScope, $scope, $ionicScrollDelegate, $location, $state, resume, edu, wxUser, tip, corp) {
        var vm = $scope.vm = {};
