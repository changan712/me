define(['angular', 'app'], function (angular, md) {


    md.service('dialog', ['$modal', '$q', '$timeout', function ($modal, $q, $timeout) {

            return {
                alert: function (msg, option) {
                    var defer = $q.defer();
                    var setting = {
                        btn: {label: '确定', style: 'btn-success'},
                        size: 'sm',
                        title: '提示'
                    };
                ...
                confirm: function (msg, option) {
                    var defer = $q.defer();
                    var setting = {
                        btnOk: {label: '确定', style: 'btn-success'},
