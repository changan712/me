...
define([
    ...
    md.controller('resumeEditCtrl', ['$rootScope', '$scope', '$ionicModal', '$ionicActionSheet', '$state', 'resumeSev', 'edu', 'wxUser', 'tip', function ($rootScope, $scope, $ionicModal, $ionicActionSheet, $state, resumeSev, edu, wxUser, tip) {
        var vm = $scope.vm = {};
