 ...
 * Now, when you call <code>browser().navigateTo('list.html')</code> in your scenario test, the browser will open /your-prefix/list.html.
 * That matches the proxy, so JSTD will proxy this request to http://localhost:8000/list.html.
 */
