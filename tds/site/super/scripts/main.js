...
require.config({
    paths: {
        ...
        'highcharts': '../bower_components/highcharts-ng/dist/highstock.src',
        ...
        colorpicker: '../bower_components/angular-bootstrap-colorpicker-master/js/bootstrap-colorpicker-module'
...
require([
    ...
    app.run(function ($rootScope, $templateCache, admin) {
        admin.getUser(function (res) {
            $rootScope.user = res;
        })
    });
